...
def listado_modelos() -> List[str]:
    ...
    from logic.app.repositories.implementations.sqlite.modelo_repository import listado_modelos
...
def crear(m: Modelo) -> Modelo:
    ...
    from logic.app.repositories.implementations.sqlite.modelo_repository import crear
    return crear(m)
...
def actualizar(m: Modelo) -> Modelo:
    ...
    from logic.app.repositories.implementations.sqlite.modelo_repository import actualizar
    return actualizar(m)
...
def buscar(id: any) -> Modelo:
    ...
    from logic.app.repositories.implementations.sqlite.modelo_repository import buscar
    return buscar(id)
...
def buscar_por_filtros(filtros: dict = None) -> List[Modelo]:
    ...
    from logic.app.repositories.implementations.sqlite.modelo_repository import buscar_por_filtros
...
def buscar_por_nombre(nombre: str) -> Modelo:
    ...
    from logic.app.repositories.implementations.sqlite.modelo_repository import buscar_por_nombre
...
def borrar(id: any):
    ...
    from logic.app.repositories.implementations.sqlite.modelo_repository import borrar
    borrar(id)
