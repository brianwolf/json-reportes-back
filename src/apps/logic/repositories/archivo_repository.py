...
from apps.logic.models.modelos import Archivo, TipoArchivo
...
def listado_archivos(id_modelo: any, tipo: TipoArchivo = TipoArchivo.MODELO) -> List[str]:
    ...
    from apps.logic.repositories.implementations.sqlite.archivo_repository import listado_archivos
...
def crear(a: Archivo) -> Archivo:
    ...
    from apps.logic.repositories.implementations.sqlite.archivo_repository import crear
    return crear(a)
...
def actualizar(a: Archivo) -> Archivo:
    ...
    from apps.logic.repositories.implementations.sqlite.archivo_repository import actualizar
    return actualizar(a)
...
def buscar(id: any) -> Archivo:
    ...
    from apps.logic.repositories.implementations.sqlite.archivo_repository import buscar
    return buscar(id)
...
def buscar_por_filtros(filtros: dict = None) -> List[Archivo]:
    ...
    from apps.logic.repositories.implementations.sqlite.archivo_repository import buscar_por_filtros
...
def borrar(id: any):
    ...
    from apps.logic.repositories.implementations.sqlite.archivo_repository import borrar
    borrar(id)
