...
from src.libs.rest.src.blue_prints import carga_dinamica_de_bps
from src.libs.rest.src.error_handlers import error_handler_bp
from src.libs.rest.src.json import JSONEncoderPersonalizado
